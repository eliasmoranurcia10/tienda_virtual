...
<body>
    <div>
                ...
                <td width="33.33%">
                    <div class="text-right">
                        <p>
                            ...
                            Transcción: <?= $orden["idtransaccionpaypal"] ?> <br>
                            <?php
                            } else { ?>
        ...
        <div class="text-center">
            <p>Si tienes preguntas sobre tu pedido, <br> póngase en contacto con nombre, teléfono y Email</p>
